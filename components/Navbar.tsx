  ...
  export default function Navbar() {
    ...
    return (
      <nav className="sticky top-0 z-50 light:bg-white/95 dark:bg-gray-900/95 light:backdrop-blur-xl light:border-b light:border-gray-200/50 dark:border-gray-600/50 light:shadow-lg shadow-gray-900/5 dark:shadow-black/30">
